...
class AnkiConnect:
    def __init__(self):
        ...
        self.images_folder_path = r"C:\Users\icefr\AppData\Roaming\Anki2\Użytkownik 1\collection.media"
    ...
    def spellcheck_deck(self, deck_name):
        ...
        for note_data in notes_list:
            ...
            if misspells_front:
                ...
                self.modding_card(note_id, front_note + "\n<br>" + misspells_front_strig, back_note)
            ...
            if misspells_back:
                self.add_tag_to_note(note_id, self.MISSPELL_LABEL)
                self.modding_card(note_id, front_note, back_note + "\n<br>" + misspells_back_strig)
    ...
    def add_flashcard(self, english_word, pl_translation, audio_en, deck=None, tags=None):
        if deck == None:
