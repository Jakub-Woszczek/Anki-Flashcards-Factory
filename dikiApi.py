...
class DikiApi:
    def __init__(self):
        self.audio_path = r"C:\Users\icefr\AppData\Roaming\Anki2\Użytkownik 1\collection.media"
        pass
    ...
    def dicky_possible_spellings(self, phrase):
        ...
        phrases = self.dicky_similar_phrases(soup)
    ...
    def word_request_diki(self,word):
        ...
        # szukamy div o klasie dictionarySuggestions
        div = soup.find("div", class_="dictionarySuggestions")
        
        # element = soup.select_one("div.hws h1 span.hw")
        # if element:
        #     auto_correction = element.get_text()
        #     # print(f'auto_correction: {auto_correction}')
        #     if auto_correction != word:
        #         print(f"Autokorekta {word} -> {auto_correction}")
        #         return True
    ...
    def dicky_similar_phrases(self, soup):
